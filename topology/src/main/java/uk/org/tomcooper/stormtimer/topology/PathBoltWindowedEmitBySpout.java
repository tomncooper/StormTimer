...
public class PathBoltWindowedEmitBySpout extends BaseWindowedBolt {
	...
	public PathBoltWindowedEmitBySpout(String outputStreamName) {
		this.outputStreamName = outputStreamName;
	}

	public PathBoltWindowedEmitBySpout() {
		this("pathMessages");
	}
